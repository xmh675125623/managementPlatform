...
/**
* @author xingmh
* @version 创建时间：2023年2月22日 上午10:16:48
* 类说明
*/
public interface IDSLogMapper {
	 ...
	 * @param tableName
	 */
	public void insertBatch(@Param(value="list") List<IDSLog> list, 
	 ...
	 * @param condition
	 */
	public List<IDSLog> search(@Param(value="table_name") String tableName,
