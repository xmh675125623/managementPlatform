...
CREATE TABLE `audit_event_level`  (
  ...
  `event_level` int(255) NULL DEFAULT NULL COMMENT '事件等级',
...
CREATE TABLE `audit_modbus_function_code`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `type` int(255) NULL DEFAULT NULL COMMENT '协议类型，1：modbus_tcp',
  `mode` int(255) NULL DEFAULT NULL COMMENT '读写类型，1：读，2：写，3：读写',
...
CREATE TABLE `audit_whitelist`  (
  ...
  `sport` int(255) NULL DEFAULT NULL COMMENT '源端口',
  `dport` int(255) NULL DEFAULT NULL COMMENT '目的端口',
  `protocol` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '协议类型',
  `direction` int(255) NULL DEFAULT NULL COMMENT '方向1:单向，2:双向',
...
CREATE TABLE `audit_whitelist_rule`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `whitelist_id` int(255) NULL DEFAULT NULL COMMENT '白名单id',
  `type` int(255) NULL DEFAULT NULL COMMENT '规则类型，1：普通，2：modbus_tcp',
...
CREATE TABLE `firewall_anti_attack_dos`  (
  ...
  `tcp_syn_flood` int(11) NULL DEFAULT 0,
  `win_nuke` int(11) NULL DEFAULT 0,
  `smurf` int(11) NULL DEFAULT 0,
  `land` int(11) NULL DEFAULT 0,
  `udp_flood` int(11) NULL DEFAULT 0,
  `icmp_flood` int(11) NULL DEFAULT 0,
  `teardrop` int(11) NULL DEFAULT 0,
...
CREATE TABLE `firewall_anti_attack_scan`  (
  `device_name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '设备名',
  `tcp_scan` int(11) NULL DEFAULT 0,
  `udp_scan` int(11) NULL DEFAULT 0,
  PRIMARY KEY (`device_name`) USING BTREE
...
CREATE TABLE `firewall_asset`  (
  ...
  `delete_flag` int(11) NULL DEFAULT 0 COMMENT '删除标志位',
  `add_time` datetime(0) NULL DEFAULT NULL,
  `add_user` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `update_time` datetime(0) NULL DEFAULT NULL,
  `update_user` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
...
CREATE TABLE `firewall_custom_route`  (
  ...
  `in_eth` int(255) NULL DEFAULT NULL COMMENT '入口设备',
  `out_eth` int(255) NULL DEFAULT NULL COMMENT '出口设备',
...
CREATE TABLE `firewall_device`  (
  ...
  `mode` int(255) NULL DEFAULT 1 COMMENT '当前模式1初始模式2测试模式3运行模式',
  ...
  `del_flag` int(255) NULL DEFAULT NULL COMMENT '删除标志位',
  ...
  `styles` int(255) NULL DEFAULT NULL COMMENT '状态0正常1非正常',
  ...
  `syslog_power` int(1) NULL DEFAULT 0 COMMENT 'syslog开关',
  ...
  `snmp_power` int(1) NULL DEFAULT 0 COMMENT 'SNMP开关',
  ...
  `ntp_power` int(1) NULL DEFAULT NULL COMMENT 'NTP开关',
  `anti_attack_dos` int(11) NULL DEFAULT 0 COMMENT '是否开启全局抗dos攻击，0：关闭，1：开启',
  `anti_attack_scan` int(11) NULL DEFAULT 0 COMMENT '是否开启全局扫描，0：关闭，1：开启',
  `default_rule_action` int(255) NULL DEFAULT 2 COMMENT '默认规则行为，1：放行，2：拦截',
  `default_rule_log` int(255) NULL DEFAULT 1 COMMENT '默认日志记录，1：开启，2：关闭',
  `dynamic_route_power` int(11) NULL DEFAULT 0 COMMENT '动态路由开关',
  `dynamic_route_action` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT 'RIP' COMMENT '动态路由RIP/OSPF',
  `auto_ip_mac` int(1) NULL DEFAULT 0 COMMENT 'ip/mac自动开关',
...
CREATE TABLE `firewall_device_ethernet`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `device_name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '设备名',
  `number` int(11) NULL DEFAULT NULL COMMENT '网口标号',
  `bypass_number` int(11) NULL DEFAULT NULL COMMENT '互为bypass网口标号',
  `mode` int(255) NULL DEFAULT 0 COMMENT '网口模式1：网桥模式，2：路由模式',
...
CREATE TABLE `firewall_mac`  (
  ...
  `source` int(255) NULL DEFAULT NULL COMMENT '来源 0：手动添加，1：扫描添加',
  `delete_flag` int(255) NULL DEFAULT 0 COMMENT '删除标志位',
  `add_time` datetime(0) NULL DEFAULT NULL COMMENT '添加时间',
...
CREATE TABLE `firewall_nat`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `device_name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '设备名',
  `nat_type` int(255) NULL DEFAULT NULL COMMENT 'nat类型1：snat，2：dnat，3：动态nat',
  `protocol` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '协议类型',
  `ip_address` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT 'ip地址',
...
CREATE TABLE `firewall_report_counter`  (
  ...
  `count_type` int(255) NULL DEFAULT NULL COMMENT '计数类型，1：日志模块，2：日志等级',
  `count_title` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '计数题目',
  `count_num` bigint(20) NULL DEFAULT NULL COMMENT '数量',
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `firewall_route`  (
  ...
  `gateway` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '网关',
  `type` int(255) NULL DEFAULT NULL COMMENT '路由类型0：默认路由，1：主机路由，2：网络路由',
  `out_eth` int(255) NULL DEFAULT NULL COMMENT '出口设备',
  `add_time` datetime(0) NULL DEFAULT NULL COMMENT '添加时间',
  `add_user` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `update_time` datetime(0) NULL DEFAULT NULL,
...
CREATE TABLE `firewall_rule_custom`  (
  `id` int(40) NOT NULL AUTO_INCREMENT COMMENT '唯一id',
...
CREATE TABLE `firewall_rule_opc_classic_tcp`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `session` int(255) NULL DEFAULT 0 COMMENT '读写控制0:OFF,1:ON',
  `inspect` int(255) NULL DEFAULT 0 COMMENT '合理性检查1：是，0：否',
  `tos` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '超时时间',
  `zcheck` int(255) NULL DEFAULT 0 COMMENT '帧检查 0：否，1：是',
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `firewall_rule_temp`  (
  ...
  `type` int(40) NULL DEFAULT NULL COMMENT '规则类型1普通规则2特殊规则',
  `add_flag` int(1) NULL DEFAULT 1 COMMENT '是否已经添加到服务端 0是1否 默认 1',
...
CREATE TABLE `firewall_session_control`  (
  ...
  `num` int(11) NULL DEFAULT NULL COMMENT '最大会话数',
  `delete_flag` int(255) NULL DEFAULT 0 COMMENT '删除标志位',
  `add_time` datetime(0) NULL DEFAULT NULL,
  `add_user` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `update_time` datetime(0) NULL DEFAULT NULL,
...
CREATE TABLE `firewall_session_setting`  (
  `device_name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '设备名',
  `line_complete` int(11) NULL DEFAULT NULL COMMENT '连接完整性：0：关，1：开',
  `tcp_time` int(11) NULL DEFAULT NULL COMMENT 'tcp协议会话维持时间：单位秒',
  PRIMARY KEY (`device_name`) USING BTREE
...
CREATE TABLE `firewall_strategy`  (
  ...
  `device_name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '设备名',
  `group_id` int(11) NULL DEFAULT NULL COMMENT '策略组id',
  `strategy_name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '策略名',
  `rule_id` int(255) NULL DEFAULT NULL COMMENT '规则id（规则库）',
  `rule_type` int(255) NULL DEFAULT NULL COMMENT '规则类型0：自定义规则，1：普通规则，2：特殊规则，3：opc，4：modbus，5：iec104',
  ...
  `time_type` int(11) NULL DEFAULT NULL COMMENT '1:绝对时间，2:相对时间',
  `relative_time` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '相对时间，周',
  `rule_action` int(255) NULL DEFAULT NULL COMMENT '规则1：放行，2：拦截',
  `log_power` int(255) NULL DEFAULT NULL COMMENT '是否开启日志：1：开启，2：关闭',
  `input_eth` int(11) NULL DEFAULT NULL COMMENT '进口网口',
  `output_eth` int(255) NULL DEFAULT NULL COMMENT '出口网口',
  `delete_flag` int(255) NULL DEFAULT 0 COMMENT '删除标志位',
  `sync_flag` int(255) NULL DEFAULT 0 COMMENT '是否上传设备0：否，1：是',
  `add_time` datetime(0) NULL DEFAULT NULL,
  `add_user` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `update_time` datetime(0) NULL DEFAULT NULL,
  `update_user` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
...
CREATE TABLE `firewall_strategy_group`  (
  ...
  `source_asset` int(255) NULL DEFAULT NULL COMMENT '源资产id',
  `target_asset` int(255) NULL DEFAULT NULL COMMENT '目的资产id',
  `delete_flag` int(255) NULL DEFAULT 0 COMMENT '删除标识',
  `add_time` datetime(0) NULL DEFAULT NULL,
  `add_user` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `update_time` datetime(0) NULL DEFAULT NULL,
  `update_user` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
...
CREATE TABLE `iec104_asdu_constant`  (
  ...
  `type` int(255) NULL DEFAULT NULL COMMENT '类型，1:类型标识,2:传输原因',
...
CREATE TABLE `plat_admin_user`  (
  ...
  `update_user` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '变更者',
  `remark` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '备注',
  `del_flag` int(1) NULL DEFAULT 0 COMMENT '删除标志 1：删除',
  `num` int(11) NULL DEFAULT 0 COMMENT '登录失败次数',
...
INSERT INTO `plat_admin_user` VALUES (1, 'admin', 'F3018AA3E291B9C5D2E4C2C9AE99884B', 'c4ca4238a0b923820dcc509a6f75849b', 1, '超级管理员', '2018-01-01 00:00:00', '系统初始', '2018-01-01 00:00:00', '系统初始', NULL, 0, 0, '2022-11-30 10:29:54', NULL, '2022-11-30 10:29:49');
...
CREATE TABLE `plat_data_dictionary_item`  (
  ...
  `dic_id` int(255) NULL DEFAULT NULL,
  ...
  `item_sort` int(255) NULL DEFAULT NULL COMMENT '排序',
  `delete_flag` int(255) NULL DEFAULT 0 COMMENT '删除标志位',
  `add_time` datetime(0) NULL DEFAULT NULL,
  `add_user` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `update_time` datetime(0) NULL DEFAULT NULL,
...
CREATE TABLE `plat_device`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `type` int(255) NULL DEFAULT NULL COMMENT '类型 1:防火墙 2:审计',
  `device_name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '设备名',
...
INSERT INTO `plat_device` VALUES (13, 3, '网关测试', NULL, '192.168.0.21', NULL, NULL, NULL, NULL, '2022-10-31 09:46:35');
...
CREATE TABLE `plat_function`  (
  ...
  `level` int(1) NULL DEFAULT NULL COMMENT '等级 1：一级菜单，2：二级菜单，3：功能',
  `del_flag` int(1) NULL DEFAULT 0 COMMENT '删除标志位 1：删除',
  `is_menu` int(1) NULL DEFAULT 0 COMMENT '是否为菜单 1：是',
  `option_password_auth` int(11) NULL DEFAULT 0 COMMENT '是否需要验证操作密码1：需要',
  `remark` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '备注',
...
INSERT INTO `plat_function` VALUES (204, NULL, 'Kibana首页', NULL, NULL, '/display/index', NULL, 203, 2, 0, 1, 0, NULL, 1, NULL, NULL, NULL, NULL);
INSERT INTO `plat_function` VALUES (205, NULL, 'KibanaDashboards', NULL, NULL, '/display/dashboards', NULL, 203, 2, 0, 1, 0, NULL, 2, NULL, NULL, NULL, NULL);
INSERT INTO `plat_function` VALUES (206, NULL, '设备状态', NULL, NULL, 'http://192.168.0.36/ui/core/license', NULL, 203, 2, 0, 1, 0, NULL, 3, NULL, NULL, NULL, NULL);
...
-- ----------------------------
-- Table structure for plat_operate_log_202205
-- ----------------------------
DROP TABLE IF EXISTS `plat_operate_log_202205`;
CREATE TABLE `plat_operate_log_202205`  (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `type` varchar(11) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `function_id` int(11) NULL DEFAULT NULL COMMENT '功能id',
  `function_name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '功能名称',
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 8 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '用户界面操作日志' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of plat_operate_log_202205
-- ----------------------------
INSERT INTO `plat_operate_log_202205` VALUES (1, '登录', -10000, '用户登录', '用户名：admin 密码：F3018AA3E291B9C5D2E4C2C9AE99884B ', 0, NULL, '验证成功', '0:0:0:0:0:0:0:1', '2022-05-25 15:34:00');
INSERT INTO `plat_operate_log_202205` VALUES (2, '功能请求', 22, '个人信息查询', NULL, 1, '超级管理员', '验证通过', '0:0:0:0:0:0:0:1', '2022-05-25 15:34:18');
INSERT INTO `plat_operate_log_202205` VALUES (3, '功能请求', 23, '个人信息修改', '编辑前\n[账号：admin][密码：F3018AA3E291B9C5D2E4C2C9AE99884B][操作密码：c4ca4238a0b923820dcc509a6f75849b][角色：超级管理员][用户名：超级管理员][备注：null]\n编辑后\n[账号：admin][密码：F3018AA3E291B9C5D2E4C2C9AE99884B][操作密码：c4ca4238a0b923820dcc509a6f75849b][角色：超级管理员][用户名：超级管理员][备注：null]', 1, '超级管理员', '验证通过', '0:0:0:0:0:0:0:1', '2022-05-25 15:34:38');
INSERT INTO `plat_operate_log_202205` VALUES (4, '功能请求', 22, '个人信息查询', '用户登录信息验证失败，未通过验证', 0, NULL, '验证失败', '0:0:0:0:0:0:0:1', '2022-05-25 15:34:39');
INSERT INTO `plat_operate_log_202205` VALUES (5, '登录', -10000, '用户登录', '用户名：admin 密码：F3018AA3E291B9C5D2E4C2C9AE99884B ', 0, NULL, '验证成功', '0:0:0:0:0:0:0:1', '2022-05-25 15:34:45');
INSERT INTO `plat_operate_log_202205` VALUES (6, '功能请求', 199, '设备列表查询', NULL, 1, '超级管理员', '验证通过', '0:0:0:0:0:0:0:1', '2022-05-25 15:34:49');
INSERT INTO `plat_operate_log_202205` VALUES (7, '功能请求', 199, '设备列表查询', NULL, 1, '超级管理员', '验证通过', '0:0:0:0:0:0:0:1', '2022-05-25 15:38:39');
INSERT INTO `plat_operate_log_202205` VALUES (8, '功能请求', 199, '设备列表查询', NULL, 1, '超级管理员', '验证通过', '0:0:0:0:0:0:0:1', '2022-05-25 15:38:54');

-- ----------------------------
-- Table structure for plat_operate_log_202207
-- ----------------------------
DROP TABLE IF EXISTS `plat_operate_log_202207`;
CREATE TABLE `plat_operate_log_202207`  (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `type` varchar(11) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `function_id` int(11) NULL DEFAULT NULL COMMENT '功能id',
  `function_name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '功能名称',
...
-- ----------------------------
-- Records of plat_operate_log_202207
-- ----------------------------
INSERT INTO `plat_operate_log_202207` VALUES (1, '登录', -10000, '用户登录', '用户名：admin 密码：F3018AA3E291B9C5D2E4C2C9AE99884B ', 0, NULL, '验证成功', '0:0:0:0:0:0:0:1', '2022-07-27 14:31:54');
INSERT INTO `plat_operate_log_202207` VALUES (2, '功能请求', 22, '个人信息查询', '用户登录信息验证失败，未通过验证', 0, NULL, '验证失败', '0:0:0:0:0:0:0:1', '2022-07-27 15:20:42');
INSERT INTO `plat_operate_log_202207` VALUES (3, '登录', -10000, '用户登录', '用户名：admin 密码：F3018AA3E291B9C5D2E4C2C9AE99884B ', 0, NULL, '验证成功', '0:0:0:0:0:0:0:1', '2022-07-27 15:20:48');
INSERT INTO `plat_operate_log_202207` VALUES (4, '功能请求', 22, '个人信息查询', '用户登录信息验证失败，未通过验证', 0, NULL, '验证失败', '0:0:0:0:0:0:0:1', '2022-07-27 15:57:13');
INSERT INTO `plat_operate_log_202207` VALUES (5, '登录', -10000, '用户登录', '用户名：admin 密码：F3018AA3E291B9C5D2E4C2C9AE99884B ', 0, NULL, '验证成功', '0:0:0:0:0:0:0:1', '2022-07-27 15:57:23');
INSERT INTO `plat_operate_log_202207` VALUES (6, '功能请求', 22, '个人信息查询', NULL, 1, '超级管理员', '验证通过', '0:0:0:0:0:0:0:1', '2022-07-27 15:57:40');
INSERT INTO `plat_operate_log_202207` VALUES (7, '功能请求', 22, '个人信息查询', NULL, 1, '超级管理员', '验证通过', '0:0:0:0:0:0:0:1', '2022-07-27 15:59:21');
INSERT INTO `plat_operate_log_202207` VALUES (8, '功能请求', 22, '个人信息查询', '用户登录信息验证失败，未通过验证', 0, NULL, '验证失败', '0:0:0:0:0:0:0:1', '2022-07-27 17:17:25');
INSERT INTO `plat_operate_log_202207` VALUES (9, '登录', -10000, '用户登录', '用户名：admin 密码：F3018AA3E291B9C5D2E4C2C9AE99884B ', 0, NULL, '验证成功', '0:0:0:0:0:0:0:1', '2022-07-27 17:17:31');
INSERT INTO `plat_operate_log_202207` VALUES (10, '功能请求', 22, '个人信息查询', NULL, 1, '超级管理员', '验证通过', '0:0:0:0:0:0:0:1', '2022-07-27 17:17:33');

-- ----------------------------
-- Table structure for plat_operate_log_202208
-- ----------------------------
DROP TABLE IF EXISTS `plat_operate_log_202208`;
CREATE TABLE `plat_operate_log_202208`  (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `type` varchar(11) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `function_id` int(11) NULL DEFAULT NULL COMMENT '功能id',
  `function_name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '功能名称',
...
-- ----------------------------
-- Records of plat_operate_log_202208
-- ----------------------------
INSERT INTO `plat_operate_log_202208` VALUES (1, '登录', -10000, '用户登录', '用户名：admin 密码：F3018AA3E291B9C5D2E4C2C9AE99884B ', 0, NULL, '验证成功', '0:0:0:0:0:0:0:1', '2022-08-02 14:44:32');
INSERT INTO `plat_operate_log_202208` VALUES (2, '功能请求', 199, '设备列表查询', NULL, 1, '超级管理员', '验证通过', '0:0:0:0:0:0:0:1', '2022-08-02 14:44:33');
INSERT INTO `plat_operate_log_202208` VALUES (3, '功能请求', 199, '设备列表查询', NULL, 1, '超级管理员', '验证通过', '0:0:0:0:0:0:0:1', '2022-08-02 14:44:40');
INSERT INTO `plat_operate_log_202208` VALUES (4, '功能请求', 199, '设备列表查询', '用户登录信息验证失败，未通过验证', 0, NULL, '验证失败', '0:0:0:0:0:0:0:1', '2022-08-02 17:23:29');
INSERT INTO `plat_operate_log_202208` VALUES (5, '登录', -10000, '用户登录', '用户名：admin 密码：F3018AA3E291B9C5D2E4C2C9AE99884B ', 0, NULL, '验证成功', '0:0:0:0:0:0:0:1', '2022-08-03 09:23:48');
INSERT INTO `plat_operate_log_202208` VALUES (6, '功能请求', 22, '个人信息查询', '用户登录信息验证失败，未通过验证', 0, NULL, '验证失败', '0:0:0:0:0:0:0:1', '2022-08-03 13:39:04');
INSERT INTO `plat_operate_log_202208` VALUES (7, '登录', -10000, '用户登录', '用户名：admin 密码：F3018AA3E291B9C5D2E4C2C9AE99884B ', 0, NULL, '验证成功', '0:0:0:0:0:0:0:1', '2022-08-03 13:39:13');
INSERT INTO `plat_operate_log_202208` VALUES (8, '功能请求', 22, '个人信息查询', NULL, 1, '超级管理员', '验证通过', '0:0:0:0:0:0:0:1', '2022-08-03 13:39:20');
INSERT INTO `plat_operate_log_202208` VALUES (9, '登录', -10000, '用户登录', '用户名：admin 密码：F3018AA3E291B9C5D2E4C2C9AE99884B ', 0, NULL, '验证成功', '0:0:0:0:0:0:0:1', '2022-08-09 16:41:40');
INSERT INTO `plat_operate_log_202208` VALUES (10, '功能请求', 22, '个人信息查询', '用户登录信息验证失败，未通过验证', 0, NULL, '验证失败', '0:0:0:0:0:0:0:1', '2022-08-10 16:24:50');
INSERT INTO `plat_operate_log_202208` VALUES (11, '登录', -10000, '用户登录', '用户名：admin 密码：F3018AA3E291B9C5D2E4C2C9AE99884B ', 0, NULL, '验证成功', '0:0:0:0:0:0:0:1', '2022-08-10 16:24:56');
INSERT INTO `plat_operate_log_202208` VALUES (12, '功能请求', 199, '设备列表查询', NULL, 1, '超级管理员', '验证通过', '0:0:0:0:0:0:0:1', '2022-08-10 16:24:58');
INSERT INTO `plat_operate_log_202208` VALUES (13, '功能请求', 22, '个人信息查询', NULL, 1, '超级管理员', '验证通过', '0:0:0:0:0:0:0:1', '2022-08-10 16:25:05');
INSERT INTO `plat_operate_log_202208` VALUES (14, '登录', -10000, '用户登录', '用户名：admin 密码：F3018AA3E291B9C5D2E4C2C9AE99884B ', 0, NULL, '验证成功', '0:0:0:0:0:0:0:1', '2022-08-17 10:58:48');
INSERT INTO `plat_operate_log_202208` VALUES (15, '登录', -10000, '用户登录', '用户名：admin 密码：F3018AA3E291B9C5D2E4C2C9AE99884B ', 0, NULL, '验证成功', '0:0:0:0:0:0:0:1', '2022-08-25 16:20:01');
INSERT INTO `plat_operate_log_202208` VALUES (16, '登录', -10000, '用户登录', '用户名：admin 密码：F3018AA3E291B9C5D2E4C2C9AE99884B ', 0, NULL, '验证成功', '0:0:0:0:0:0:0:1', '2022-08-31 09:52:10');
INSERT INTO `plat_operate_log_202208` VALUES (17, '功能请求', 22, '个人信息查询', '用户登录信息验证失败，未通过验证', 0, NULL, '验证失败', '0:0:0:0:0:0:0:1', '2022-08-31 15:33:12');
INSERT INTO `plat_operate_log_202208` VALUES (18, '登录', -10000, '用户登录', '用户名：admin 密码：F3018AA3E291B9C5D2E4C2C9AE99884B ', 0, NULL, '验证成功', '0:0:0:0:0:0:0:1', '2022-08-31 15:33:18');
INSERT INTO `plat_operate_log_202208` VALUES (19, '功能请求', 22, '个人信息查询', NULL, 1, '超级管理员', '验证通过', '0:0:0:0:0:0:0:1', '2022-08-31 15:33:20');
INSERT INTO `plat_operate_log_202208` VALUES (20, '功能请求', 22, '个人信息查询', NULL, 1, '超级管理员', '验证通过', '0:0:0:0:0:0:0:1', '2022-08-31 15:33:24');
INSERT INTO `plat_operate_log_202208` VALUES (21, '功能请求', 22, '个人信息查询', NULL, 1, '超级管理员', '验证通过', '0:0:0:0:0:0:0:1', '2022-08-31 15:36:29');
INSERT INTO `plat_operate_log_202208` VALUES (22, '功能请求', 22, '个人信息查询', NULL, 1, '超级管理员', '验证通过', '0:0:0:0:0:0:0:1', '2022-08-31 15:56:01');
INSERT INTO `plat_operate_log_202208` VALUES (23, '功能请求', 22, '个人信息查询', NULL, 1, '超级管理员', '验证通过', '0:0:0:0:0:0:0:1', '2022-08-31 15:56:06');

-- ----------------------------
-- Table structure for plat_operate_log_202209
-- ----------------------------
DROP TABLE IF EXISTS `plat_operate_log_202209`;
CREATE TABLE `plat_operate_log_202209`  (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `type` varchar(11) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `function_id` int(11) NULL DEFAULT NULL COMMENT '功能id',
  `function_name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '功能名称',
  ...
  `add_time` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '添加时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 28 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '用户界面操作日志' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of plat_operate_log_202209
-- ----------------------------
INSERT INTO `plat_operate_log_202209` VALUES (1, '登录', -10000, '用户登录', '用户名：admin 密码：F3018AA3E291B9C5D2E4C2C9AE99884B ', 0, NULL, '验证成功', '0:0:0:0:0:0:0:1', '2022-09-01 08:39:36');
INSERT INTO `plat_operate_log_202209` VALUES (2, '功能请求', 22, '个人信息查询', NULL, 1, '超级管理员', '验证通过', '0:0:0:0:0:0:0:1', '2022-09-01 08:39:57');
INSERT INTO `plat_operate_log_202209` VALUES (3, '功能请求', 22, '个人信息查询', NULL, 1, '超级管理员', '验证通过', '0:0:0:0:0:0:0:1', '2022-09-01 08:52:52');
INSERT INTO `plat_operate_log_202209` VALUES (4, '功能请求', 22, '个人信息查询', NULL, 1, '超级管理员', '验证通过', '0:0:0:0:0:0:0:1', '2022-09-01 08:52:55');
INSERT INTO `plat_operate_log_202209` VALUES (5, '功能请求', 22, '个人信息查询', NULL, 1, '超级管理员', '验证通过', '0:0:0:0:0:0:0:1', '2022-09-01 08:53:00');
INSERT INTO `plat_operate_log_202209` VALUES (6, '功能请求', 22, '个人信息查询', NULL, 1, '超级管理员', '验证通过', '0:0:0:0:0:0:0:1', '2022-09-01 08:57:35');
INSERT INTO `plat_operate_log_202209` VALUES (7, '功能请求', 22, '个人信息查询', NULL, 1, '超级管理员', '验证通过', '0:0:0:0:0:0:0:1', '2022-09-01 08:57:39');
INSERT INTO `plat_operate_log_202209` VALUES (8, '功能请求', 22, '个人信息查询', NULL, 1, '超级管理员', '验证通过', '0:0:0:0:0:0:0:1', '2022-09-01 09:03:19');
INSERT INTO `plat_operate_log_202209` VALUES (9, '功能请求', 22, '个人信息查询', NULL, 1, '超级管理员', '验证通过', '0:0:0:0:0:0:0:1', '2022-09-01 09:16:55');
INSERT INTO `plat_operate_log_202209` VALUES (10, '功能请求', 22, '个人信息查询', '用户登录信息验证失败，未通过验证', 0, NULL, '验证失败', '0:0:0:0:0:0:0:1', '2022-09-01 16:00:47');
INSERT INTO `plat_operate_log_202209` VALUES (11, '登录', -10000, '用户登录', '用户名：admin 密码：F3018AA3E291B9C5D2E4C2C9AE99884B ', 0, NULL, '验证成功', '0:0:0:0:0:0:0:1', '2022-09-01 16:00:53');
INSERT INTO `plat_operate_log_202209` VALUES (12, '功能请求', 22, '个人信息查询', NULL, 1, '超级管理员', '验证通过', '0:0:0:0:0:0:0:1', '2022-09-01 16:00:55');
INSERT INTO `plat_operate_log_202209` VALUES (13, '功能请求', 22, '个人信息查询', NULL, 1, '超级管理员', '验证通过', '0:0:0:0:0:0:0:1', '2022-09-01 16:01:25');
INSERT INTO `plat_operate_log_202209` VALUES (14, '功能请求', 22, '个人信息查询', NULL, 1, '超级管理员', '验证通过', '0:0:0:0:0:0:0:1', '2022-09-01 16:01:27');
INSERT INTO `plat_operate_log_202209` VALUES (15, '登录', -10000, '用户登录', '用户名：admin 密码：F3018AA3E291B9C5D2E4C2C9AE99884B ', 0, NULL, '验证成功', '0:0:0:0:0:0:0:1', '2022-09-02 16:01:22');
INSERT INTO `plat_operate_log_202209` VALUES (16, '登录', -10000, '用户登录', '用户名：admin 密码：F3018AA3E291B9C5D2E4C2C9AE99884B ', 0, NULL, '验证失败', '0:0:0:0:0:0:0:1', '2022-09-05 13:09:43');
INSERT INTO `plat_operate_log_202209` VALUES (17, '登录', -10000, '用户登录', '用户名：admin 密码：F3018AA3E291B9C5D2E4C2C9AE99884B ', 0, NULL, '验证成功', '0:0:0:0:0:0:0:1', '2022-09-05 13:09:49');
INSERT INTO `plat_operate_log_202209` VALUES (18, '功能请求', 199, '设备列表查询', '用户登录信息验证失败，未通过验证', 0, NULL, '验证失败', '0:0:0:0:0:0:0:1', '2022-09-06 08:48:27');
INSERT INTO `plat_operate_log_202209` VALUES (19, '登录', -10000, '用户登录', '用户名：admin 密码：F3018AA3E291B9C5D2E4C2C9AE99884B ', 0, NULL, '验证成功', '0:0:0:0:0:0:0:1', '2022-09-06 08:48:36');
INSERT INTO `plat_operate_log_202209` VALUES (20, '功能请求', 22, '个人信息查询', NULL, 1, '超级管理员', '验证通过', '0:0:0:0:0:0:0:1', '2022-09-06 08:48:40');
INSERT INTO `plat_operate_log_202209` VALUES (21, '登录', -10000, '用户登录', '用户名：admin 密码：F3018AA3E291B9C5D2E4C2C9AE99884B ', 0, NULL, '验证成功', '0:0:0:0:0:0:0:1', '2022-09-07 16:45:02');
INSERT INTO `plat_operate_log_202209` VALUES (22, '登录', -10000, '用户登录', '用户名：admin 密码：F3018AA3E291B9C5D2E4C2C9AE99884B ', 0, NULL, '验证成功', '0:0:0:0:0:0:0:1', '2022-09-09 08:43:58');
INSERT INTO `plat_operate_log_202209` VALUES (23, '登录', -10000, '用户登录', '用户名：admin 密码：F3018AA3E291B9C5D2E4C2C9AE99884B ', 0, NULL, '验证成功', '0:0:0:0:0:0:0:1', '2022-09-14 14:24:20');
INSERT INTO `plat_operate_log_202209` VALUES (24, '登录', -10000, '用户登录', '用户名：admin 密码：F3018AA3E291B9C5D2E4C2C9AE99884B ', 0, NULL, '验证成功', '0:0:0:0:0:0:0:1', '2022-09-15 15:56:21');
INSERT INTO `plat_operate_log_202209` VALUES (25, '登录', -10000, '用户登录', '用户名：admin 密码：F3018AA3E291B9C5D2E4C2C9AE99884B ', 0, NULL, '验证成功', '0:0:0:0:0:0:0:1', '2022-09-19 09:29:25');
INSERT INTO `plat_operate_log_202209` VALUES (26, '登录', -10000, '用户登录', '用户名：admin 密码：F3018AA3E291B9C5D2E4C2C9AE99884B ', 0, NULL, '验证成功', '0:0:0:0:0:0:0:1', '2022-09-22 16:21:30');
INSERT INTO `plat_operate_log_202209` VALUES (27, '登录', -10000, '用户登录', '用户名：admin 密码：F3018AA3E291B9C5D2E4C2C9AE99884B ', 0, NULL, '验证成功', '0:0:0:0:0:0:0:1', '2022-09-23 16:22:32');
INSERT INTO `plat_operate_log_202209` VALUES (28, '功能请求', 22, '个人信息查询', NULL, 1, '超级管理员', '验证通过', '0:0:0:0:0:0:0:1', '2022-09-23 16:29:49');

-- ----------------------------
-- Table structure for plat_operate_log_202210
-- ----------------------------
DROP TABLE IF EXISTS `plat_operate_log_202210`;
CREATE TABLE `plat_operate_log_202210`  (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `type` varchar(11) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `function_id` int(11) NULL DEFAULT NULL COMMENT '功能id',
  `function_name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '功能名称',
  ...
  `add_time` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '添加时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 26 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '用户界面操作日志' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of plat_operate_log_202210
-- ----------------------------
INSERT INTO `plat_operate_log_202210` VALUES (1, '登录', -10000, '用户登录', '用户名：admin 密码：F3018AA3E291B9C5D2E4C2C9AE99884B ', 0, NULL, '验证成功', '0:0:0:0:0:0:0:1', '2022-10-11 09:27:29');
INSERT INTO `plat_operate_log_202210` VALUES (2, '登录', -10000, '用户登录', '用户名：admin 密码：F3018AA3E291B9C5D2E4C2C9AE99884B ', 0, NULL, '验证成功', '0:0:0:0:0:0:0:1', '2022-10-18 15:10:22');
INSERT INTO `plat_operate_log_202210` VALUES (3, '登录', -10000, '用户登录', '用户名：admin 密码：F3018AA3E291B9C5D2E4C2C9AE99884B ', 0, NULL, '验证成功', '0:0:0:0:0:0:0:1', '2022-10-18 15:10:45');
INSERT INTO `plat_operate_log_202210` VALUES (4, '登录', -10000, '用户登录', '用户名：admin 密码：F3018AA3E291B9C5D2E4C2C9AE99884B ', 0, NULL, '验证成功', '0:0:0:0:0:0:0:1', '2022-10-20 14:06:57');
INSERT INTO `plat_operate_log_202210` VALUES (5, '功能请求', 26, '日志查看', NULL, 1, '超级管理员', '验证通过', '0:0:0:0:0:0:0:1', '2022-10-20 14:06:57');
INSERT INTO `plat_operate_log_202210` VALUES (6, '功能请求', 9, '角色查询', NULL, 1, '超级管理员', '验证通过', '0:0:0:0:0:0:0:1', '2022-10-20 14:07:11');
INSERT INTO `plat_operate_log_202210` VALUES (7, '功能请求', 26, '日志查看', NULL, 1, '超级管理员', '验证通过', '0:0:0:0:0:0:0:1', '2022-10-20 14:08:25');
INSERT INTO `plat_operate_log_202210` VALUES (8, '登录', -10000, '用户登录', '用户名：admin 密码：F3018AA3E291B9C5D2E4C2C9AE99884B ', 0, NULL, '验证成功', '0:0:0:0:0:0:0:1', '2022-10-21 16:44:53');
INSERT INTO `plat_operate_log_202210` VALUES (9, '功能请求', 26, '日志查看', NULL, 1, '超级管理员', '验证通过', '0:0:0:0:0:0:0:1', '2022-10-21 16:44:54');
INSERT INTO `plat_operate_log_202210` VALUES (10, '功能请求', 22, '个人信息查询', NULL, 1, '超级管理员', '验证通过', '0:0:0:0:0:0:0:1', '2022-10-21 16:46:13');
INSERT INTO `plat_operate_log_202210` VALUES (11, '功能请求', 23, '个人信息修改', '编辑前\n[账号：admin][密码：F3018AA3E291B9C5D2E4C2C9AE99884B][操作密码：c4ca4238a0b923820dcc509a6f75849b][角色：超级管理员][用户名：超级管理员][备注：null]\n编辑后\n[账号：admin][密码：F3018AA3E291B9C5D2E4C2C9AE99884B][操作密码：c4ca4238a0b923820dcc509a6f75849b][角色：超级管理员][用户名：超级管理员][备注：null]', 1, '超级管理员', '验证通过', '0:0:0:0:0:0:0:1', '2022-10-21 16:46:43');
INSERT INTO `plat_operate_log_202210` VALUES (12, '功能请求', 22, '个人信息查询', '用户登录信息验证失败，未通过验证', 0, NULL, '验证失败', '0:0:0:0:0:0:0:1', '2022-10-21 16:46:43');
INSERT INTO `plat_operate_log_202210` VALUES (13, '登录', -10000, '用户登录', '用户名：admin 密码：F3018AA3E291B9C5D2E4C2C9AE99884B ', 0, NULL, '验证成功', '0:0:0:0:0:0:0:1', '2022-10-21 16:46:47');
INSERT INTO `plat_operate_log_202210` VALUES (14, '功能请求', 199, '设备列表查询', NULL, 1, '超级管理员', '验证通过', '0:0:0:0:0:0:0:1', '2022-10-21 16:46:52');
INSERT INTO `plat_operate_log_202210` VALUES (15, '功能请求', 26, '日志查看', NULL, 1, '超级管理员', '验证通过', '0:0:0:0:0:0:0:1', '2022-10-21 16:47:07');
INSERT INTO `plat_operate_log_202210` VALUES (16, '登录', -10000, '用户登录', '用户名：admin 密码：F3018AA3E291B9C5D2E4C2C9AE99884B ', 0, NULL, '验证成功', '0:0:0:0:0:0:0:1', '2022-10-24 09:50:15');
INSERT INTO `plat_operate_log_202210` VALUES (17, '登录', -10000, '用户登录', '用户名：admin 密码：F3018AA3E291B9C5D2E4C2C9AE99884B ', 0, NULL, '验证成功', '0:0:0:0:0:0:0:1', '2022-10-27 11:04:31');
INSERT INTO `plat_operate_log_202210` VALUES (18, '登录', -10000, '用户登录', '用户名：admin 密码：F3018AA3E291B9C5D2E4C2C9AE99884B ', 0, NULL, '验证成功', '0:0:0:0:0:0:0:1', '2022-10-31 09:19:14');
INSERT INTO `plat_operate_log_202210` VALUES (19, '功能请求', 199, '设备列表查询', NULL, 1, '超级管理员', '验证通过', '0:0:0:0:0:0:0:1', '2022-10-31 09:39:32');
INSERT INTO `plat_operate_log_202210` VALUES (20, '功能请求', 199, '设备列表查询', NULL, 1, '超级管理员', '验证通过', '0:0:0:0:0:0:0:1', '2022-10-31 09:44:07');
INSERT INTO `plat_operate_log_202210` VALUES (21, '功能请求', 199, '设备列表查询', NULL, 1, '超级管理员', '验证通过', '0:0:0:0:0:0:0:1', '2022-10-31 09:44:33');
INSERT INTO `plat_operate_log_202210` VALUES (22, '功能请求', 200, '设备添加', '[类型：][设备名：网关测试][设备别名：null][ip地址：192.168.0.21][访问url：null][mac地址：null][子网掩码：null][默认网关：null][备注：null]', 1, '超级管理员', '验证通过', '0:0:0:0:0:0:0:1', '2022-10-31 09:46:35');
INSERT INTO `plat_operate_log_202210` VALUES (23, '功能请求', 199, '设备列表查询', NULL, 1, '超级管理员', '验证通过', '0:0:0:0:0:0:0:1', '2022-10-31 09:46:35');
INSERT INTO `plat_operate_log_202210` VALUES (24, '功能请求', 199, '设备列表查询', NULL, 1, '超级管理员', '验证通过', '0:0:0:0:0:0:0:1', '2022-10-31 09:46:37');
INSERT INTO `plat_operate_log_202210` VALUES (25, '功能请求', 199, '设备列表查询', NULL, 1, '超级管理员', '验证通过', '0:0:0:0:0:0:0:1', '2022-10-31 09:46:39');
INSERT INTO `plat_operate_log_202210` VALUES (26, '功能请求', 199, '设备列表查询', NULL, 1, '超级管理员', '验证通过', '0:0:0:0:0:0:0:1', '2022-10-31 09:47:37');

-- ----------------------------
-- Table structure for plat_operate_log_202211
-- ----------------------------
DROP TABLE IF EXISTS `plat_operate_log_202211`;
CREATE TABLE `plat_operate_log_202211`  (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `type` varchar(11) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `function_id` int(11) NULL DEFAULT NULL COMMENT '功能id',
  `function_name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '功能名称',
  ...
  `add_time` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '添加时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 15 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '用户界面操作日志' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of plat_operate_log_202211
-- ----------------------------
INSERT INTO `plat_operate_log_202211` VALUES (1, '登录', -10000, '用户登录', '用户名：admin 密码：F3018AA3E291B9C5D2E4C2C9AE99884B ', 0, NULL, '验证成功', '0:0:0:0:0:0:0:1', '2022-11-04 14:35:00');
INSERT INTO `plat_operate_log_202211` VALUES (2, '登录', -10000, '用户登录', '用户名：admin 密码：F3018AA3E291B9C5D2E4C2C9AE99884B ', 0, NULL, '验证失败', '0:0:0:0:0:0:0:1', '2022-11-04 14:36:05');
INSERT INTO `plat_operate_log_202211` VALUES (3, '登录', -10000, '用户登录', '用户名：admin 密码：F3018AA3E291B9C5D2E4C2C9AE99884B ', 0, NULL, '验证失败', '0:0:0:0:0:0:0:1', '2022-11-04 14:36:10');
INSERT INTO `plat_operate_log_202211` VALUES (4, '登录', -10000, '用户登录', '用户名：admin 密码：F3018AA3E291B9C5D2E4C2C9AE99884B ', 0, NULL, '验证成功', '0:0:0:0:0:0:0:1', '2022-11-04 14:36:22');
INSERT INTO `plat_operate_log_202211` VALUES (5, '登录', -10000, '用户登录', '用户名：admin 密码：F3018AA3E291B9C5D2E4C2C9AE99884B ', 0, NULL, '验证成功', '0:0:0:0:0:0:0:1', '2022-11-30 09:01:02');
INSERT INTO `plat_operate_log_202211` VALUES (6, '登录', -10000, '用户登录', '用户名：admin 密码：F3018AA3E291B9C5D2E4C2C9AE99884B ', 0, NULL, '验证成功', '0:0:0:0:0:0:0:1', '2022-11-30 10:29:29');
INSERT INTO `plat_operate_log_202211` VALUES (7, '功能请求', 22, '个人信息查询', NULL, 1, '超级管理员', '验证通过', '0:0:0:0:0:0:0:1', '2022-11-30 10:29:33');
INSERT INTO `plat_operate_log_202211` VALUES (8, '功能请求', 23, '个人信息修改', '编辑前\n[账号：admin][密码：F3018AA3E291B9C5D2E4C2C9AE99884B][操作密码：c4ca4238a0b923820dcc509a6f75849b][角色：超级管理员][用户名：超级管理员][备注：null]\n编辑后\n[账号：admin][密码：F3018AA3E291B9C5D2E4C2C9AE99884B][操作密码：c4ca4238a0b923820dcc509a6f75849b][角色：超级管理员][用户名：超级管理员][备注：null]', 1, '超级管理员', '验证通过', '0:0:0:0:0:0:0:1', '2022-11-30 10:29:49');
INSERT INTO `plat_operate_log_202211` VALUES (9, '功能请求', 22, '个人信息查询', '用户登录信息验证失败，未通过验证', 0, NULL, '验证失败', '0:0:0:0:0:0:0:1', '2022-11-30 10:29:49');
INSERT INTO `plat_operate_log_202211` VALUES (10, '登录', -10000, '用户登录', '用户名：admin 密码：F3018AA3E291B9C5D2E4C2C9AE99884B ', 0, NULL, '验证成功', '0:0:0:0:0:0:0:1', '2022-11-30 10:29:54');
INSERT INTO `plat_operate_log_202211` VALUES (11, '功能请求', 199, '设备列表查询', NULL, 1, '超级管理员', '验证通过', '0:0:0:0:0:0:0:1', '2022-11-30 10:29:57');
INSERT INTO `plat_operate_log_202211` VALUES (12, '功能请求', 199, '设备列表查询', NULL, 1, '超级管理员', '验证通过', '0:0:0:0:0:0:0:1', '2022-11-30 10:31:16');
INSERT INTO `plat_operate_log_202211` VALUES (13, '功能请求', 199, '设备列表查询', NULL, 1, '超级管理员', '验证通过', '0:0:0:0:0:0:0:1', '2022-11-30 10:31:26');
INSERT INTO `plat_operate_log_202211` VALUES (14, '功能请求', 5, '用户查询', NULL, 1, '超级管理员', '验证通过', '0:0:0:0:0:0:0:1', '2022-11-30 10:31:54');
...
CREATE TABLE `plat_role_function`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `role_id` int(11) NULL DEFAULT NULL COMMENT '角色id',
  `function_id` int(11) NULL DEFAULT NULL COMMENT '功能/菜单id',
  `half` int(11) NULL DEFAULT 0 COMMENT '子菜单/功能是否全部选中，0是，1不是',
  `add_time` datetime(0) NULL DEFAULT NULL,
  `add_user` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `plat_system_setting`  (
  ...
  `min` int(11) NULL DEFAULT NULL COMMENT '范围最小值',
  `max` int(11) NULL DEFAULT NULL COMMENT '范围最大值',
